package profitdevops.group.anticor.base
...
import profitdevops.group.anticor.view.custom.NotConnectionFragment
import profitdevops.group.anticor.view.custom.ProgressDialogFragment
...
abstract class BaseActivity : AppCompatActivity() {
    ...
    fun pushFragment(layoutId: Int, fragment: BaseFragment) {
        hideKeyboard()
    ...
    fun pushFragmentWithoutHistory(layoutId: Int, fragment: BaseFragment) {
        hideKeyboard()
        supportFragmentManager
            .beginTransaction()
            .add(layoutId, fragment)
//            .addToBackStack(tag)
    ...
    fun pushBtmToTopFragment(layoutId: Int, fragment: BaseFragment) {
        hideKeyboard()
        supportFragmentManager
            .beginTransaction()
    ...
    fun pushFragment(layoutId: Int, fragment: BaseFragment, args: Bundle) {
        hideKeyboard()
